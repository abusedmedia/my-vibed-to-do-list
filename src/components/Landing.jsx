        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <button
              ...
              className="bg-black hover:bg-gray-800 text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
              Get Started
            </button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-8 h-8 bg-black text-white rounded-full flex items-center justify-center font-semibold mr-4">
                  1
                </div>
                <div>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                ...
                className="bg-white hover:bg-gray-50 text-black font-semibold px-6 py-2 rounded-lg border-2 border-black transition-colors duration-200"
              >
                Sign Up
              </button>
            </div>
